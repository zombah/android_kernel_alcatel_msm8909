...
{
	printk(KERN_WARNING "stephen: watchdog_test_init.");
	if(!debugfs_create_file("fire_softlockup_reset", 0200,
			NULL, NULL, &fire_softlockup_reset_fops))
		printk(KERN_WARNING "stephen: create fire_softlockup_reset node failed!!!!!!!!!!!!!!!");
