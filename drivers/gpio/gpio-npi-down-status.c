...
//npi_down_gpio		911+65

/*  add npi down gpio in dtsi file and use function "of_get_named_gpio" get the gpio number, can't use gpio index directly ,
because in kener vision 3.10 gpio_number=base(8916 8936 8939 is 902,8909 is 911)+gpio_index , the base value we can see in "gpio_lib.conf" file .  TCTNB  ZXZ add in 2014/12/13 */
...
/* [PLATFORM]-Mod by TCTNB.ZXZ,remove gpio_request and gpio_free,GPIO69 is used by usb_otg and npi down status,
