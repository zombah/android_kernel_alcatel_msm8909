...
/*+ Cedar.Tan , PR1016851, 20150609*/
/*AKM_HAS_RESET: include sofware reset and hardware reset, should keep 1*/
#define AKM_HAS_RESET			1
/*AKM_HAS_RESET_PIN: 0=no hardware reset, only has sofware reset; 1=has hardware reset*/
...
static struct sensors_classdev sensors_cdev = {
	...
	.sensor_power = "0.35",
	.min_delay = 10000,
	.max_delay = 10000,/*Cedar.Tan , PR1016851, 20150609*/
...
static int akm_report_data(struct akm_compass_data *akm)
{
	...
	int tmp;
	uint8_t mode;/*Cedar.Tan , PR1016851, 20150609*/
	...
	if (STATUS_ERROR(dat_buf[8])) {
		...
		AKECS_Reset(akm, 0);
		/*+ Cedar.Tan add to avoid needle freeze during calibration, PR1016851, 20150609*/
		mode = akm_select_frequency(akm->delay[MAG_DATA_FLAG]);
		AKECS_SetMode(akm, mode);
		/*- Cedar.Tan add to avoid needle freeze during calibration, PR1016851, 20150609*/
