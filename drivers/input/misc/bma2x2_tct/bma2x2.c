...
#define BMA2x2_VDD_MIN_UV       2800000
#define BMA2x2_VDD_MAX_UV       2850000
...
{
/*[PLATFORM]-Begin 2015/07/22,add for new version CTS pass*/
        ktime_t timestamp;
/*[PLATFORM]-End Add*/
...
/*[PLATFORM]-Begin Add 2015/07/22,add for new version CTS pass*/
    timestamp = ktime_get_boottime();
    input_event(bma2x2->input,
			EV_SYN, SYN_TIME_SEC,
			ktime_to_timespec(timestamp).tv_sec);
    input_event(bma2x2->input, EV_SYN,
			SYN_TIME_NSEC,
