...
#define MAX_LIMIT_VALUE_GROUP1     4528     // screen max limit
#define MIN_LIMIT_VALUE_GROUP1     1495       // screen min limit
#define MAX_LIMIT_KEY_GROUP1         4024    // key_val max limit
#define MIN_LIMIT_KEY_GROUP1        1764        // key_val min limit
#define UNIFORMITY_GROUP1             60         // screen uniformity in percent

#define CTP_TEST_CFG_GROUP1 {\
	0x00,0xD0,0x02,0x00,0x05,0x05,0x05,0xC1,0x01,0x08,\
	0x28,0x0F,0x50,0x32,0x03,0x05,0x00,0x00,0x00,0x00,\
	0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x8B,0x2B,0x0C,\
	0x3E,0x40,0x0F,0x0A,0x00,0x00,0x00,0x03,0x03,0x11,\
	...
	0xFF,0x00,0x02,0x12,0x04,0x10,0x06,0x0F,0x08,0x0C,\
	0x0A,0x13,0x00,0x24,0x18,0x22,0x1C,0x21,0x1D,0x20,\
	0x1E,0x1F,0x16,0x26,0xFF,0xFF,0xFF,0xFF,0x00,0xFF,\
	0xFF,0xF9,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,\
	0xFF,0xFB,0xFF,0xFF,0x3B,0x01\
    }
...
void gtp_open_test_init(struct i2c_client *client)
{
  	u8 version = 0;
	u8 sensor_id = 0;
...
open_test_exit:
  ...
  //  gtp_irq_enable(ts);  //PXM 20150130
    gtp_send_cfg(client);
		msleep(300);//\B5ȴ\FD\C5\E4\D6\C3ˢ\D0µ\BDIC\C4ڲ\BF\A3\ACmsleep\A3\A8300\A3\A9ms\A3\ACʵ\BC\CA\C9ϻ\E1\B4\F3\D3\DA300ms\A3\AC\BF\C9\D2\D4ȷ\B1\A3IC\C5\E4\D6\C3ˢ\D0¡\A3
...
/***************************************************************/
/*Add by Luoxingxing for JRD open/short test*/
/***************************************************************/
int jrd_gt9xx_short_test(struct i2c_client * client)
{
    return gt9xx_short_test(client);
}

int jrd_gt9xx_open_test(struct i2c_client * client)
{
    return gt9xx_open_test(client);
}
